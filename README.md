...
openclaw plugins install . ; cd ~/.openclaw/extensions/zulip ; npm install ; npm install openclaw@2026.3.23 ; cp ~/.openclaw/openclaw.json.zulip ~/.openclaw/openclaw.json && openclaw gateway restart
```
